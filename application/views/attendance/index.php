               ...
               <div class="col-xl-12 col-lg-7">
                 <div class="card shadow mb-4" style="min-height: 543px">
                   ...
                   <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                     <h6 class="m-0 font-weight-bold text-primary">Isi Kehadiran Dulu!</h6>
                   </div>
                   <!-- Card Body -->
                   <div class="card-body">
                     <?php if ($weekends == true) : ?>
                       <h1 class="text-center my-3">TERIMA KASIH UDAH ABSEN!</h1>
                       ...
                       <?php if ($in == false) : ?>
                         ...
                         <div class="row mb-3">
                           <div class="col-lg-5 text-center">
                             <div class="row col">
                               <label for="image" class="col-form-label float-left">Unggah Poto Terbaik Loh!</label>
                             </div>
                           ...
                           <div class="col-lg-5 offset-lg-1 text-center">
                             <label for="notes" class="float-left">Ada Catatan Engga?</label>
                         ...
                         <?= form_close() ?>
                       <?php else : ?>
                         <h3 class="text-center my-3">SIP UDAH ABSEN</h3>
                         <h6 class="card-title text-center mb-4 px-4">Dunia Kerja Itu Keras Brodi<br>Terima kasih atas kerja keras Anda.</h6>
